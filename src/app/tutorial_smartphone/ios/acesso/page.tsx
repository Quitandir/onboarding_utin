...
export default function IOSAcessoPage() {
  return (
    <main className="min-h-screen bg-[#fdf6d8] text-[#211c75] px-6 md:px-10 py-8 flex flex-col justify-between selection:bg-[#211c75] selection:text-[#fdf6d8]">
      ...
      <div className="max-w-[900px] w-full mx-auto my-auto flex flex-col items-center gap-10 py-8">
        ...
        <header className="w-full flex items-center justify-between">
          ...
          <Image
            src="/logo_ios.png" // <-- Nome do arquivo na pasta /public
            alt="ios"
            width={100}
            height={100}
        ...
        {/* Título Cursivo */}
        <h2
          className={`${windSong.className} text-4xl sm:text-5xl md:text-6xl text-center capitalize drop-shadow-[3px_3px_2px_rgba(0,0,0,0.7)]`}
        >
        ...
        <div className="w-full flex flex-col min-[600px]:flex-row items-center justify-center gap-8 min-[600px]:gap-12 my-auto">
          ...
          <p
            className="text-lg sm:text-xl md:text-2xl text-center min-[600px]:text-left leading-relaxed tracking-wide"
            style={{ fontFamily: "'Comic Relief', system-ui, sans-serif" }}
          >
            Faça um teste clicando no ícone do Gmail no seu smartphone. Depois, em cima da sua foto, troque para a sua conta do CanoasEdu.
          </p>
          ...
          <div className="shrink-0">
            <Image
              ...
              width={250}
              height={250}
              className="w-[150px] min-[600px]:w-[250px] h-auto object-contain drop-shadow-[3px_3px_2px_rgba(0,0,0,0.7)]"
            />
          </div>
